<?php
    ...
    class report_queryControllerGenerate
    {
	    ...
	    $sql .= "'".$this->toolsController->replacecharSave($this->report_query->getStyle(), $this->dbh)."',";
	    ...
	    $sql .= "'".$this->toolsController->replacecharSave($this->report_query->getOrder_concat(), $this->dbh)."',";
	    $sql .= "'".$this->toolsController->replacecharSave($this->report_query->getOrder_by_col_1(), $this->dbh)."',";
	    $sql .= "'".$this->toolsController->replacecharSave($this->report_query->getOrder_by_col_2(), $this->dbh)."',";
	    $sql .= "'".$this->toolsController->replacecharSave($this->report_query->getOrder_by_col_3(), $this->dbh)."',";
	    $sql .= "'".$datetime."',";
	    $sql .= "'".$this->user."',";
	    $sql .= "'".$this->ip."',";
	    $sql .= "'".$datetime."',";
	    ...
	    $sql .= "`style` = '".$this->toolsController->replacecharSave($this->report_query->getStyle(),$this->dbh)."',";
	    ...
	    $sql .= "`order_concat` = '".$this->toolsController->replacecharSave($this->report_query->getOrder_concat(),$this->dbh)."',";
	    $sql .= "`order_by_col_1` = '".$this->toolsController->replacecharSave($this->report_query->getOrder_by_col_1(),$this->dbh)."',";
	    $sql .= "`order_by_col_2` = '".$this->toolsController->replacecharSave($this->report_query->getOrder_by_col_2(),$this->dbh)."',";
	    $sql .= "`order_by_col_3` = '".$this->toolsController->replacecharSave($this->report_query->getOrder_by_col_3(),$this->dbh)."',";
	    ...
	    $report_query->setStyle($row['style']);
	    ...
	    $report_query->setOrder_concat($row['order_concat']);
	    $report_query->setOrder_by_col_1($row['order_by_col_1']);
	    $report_query->setOrder_by_col_2($row['order_by_col_2']);
	    $report_query->setOrder_by_col_3($row['order_by_col_3']);
	    ...
	    $order_concat = isset($_POST['order_concat'])?$_POST['order_concat'] : "";
	    $order_by_col_1 = isset($_POST['order_by_col_1'])?$_POST['order_by_col_1'] : "";
	    $order_by_col_2 = isset($_POST['order_by_col_2'])?$_POST['order_by_col_2'] : "";
	    $order_by_col_3 = isset($_POST['order_by_col_3'])?$_POST['order_by_col_3'] : "";

	    $this->report_query->setId($id);
	    $this->report_query->setReportname($reportname);
	    $this->report_query->setStyle($style);
	    ...
	    $this->report_query->setOrder_concat($order_concat);
	    $this->report_query->setOrder_by_col_1($order_by_col_1);
	    $this->report_query->setOrder_by_col_2($order_by_col_2);
	    $this->report_query->setOrder_by_col_3($order_by_col_3);
