<?php
    ...
    class master_pendidikanControllerGenerate
    {
        protected $master_pendidikan;
        var $modulename = "master_pendidikan";
        var $dbh;
        var $limit = 20;
        var $user = "None";
        var $ip = "";
        ...
        var $lastID = "";
        var $toolsController;
        function __construct($master_pendidikan, $dbh) {
        ...
        function insertData(){
            ...
            $sql = "INSERT INTO master_pendidikan ";
            $sql .= " ( ";
	    $sql .= "`id`,";
	    $sql .= "`pendidikan`,";
	    $sql .= "`created_date`,";
	    ...
	    $sql .= "`updated_by` ";
            ...
            $sql .= " VALUES (";
	    $sql .= " null,";
	    $sql .= "'".$this->toolsController->replacecharSave($this->master_pendidikan->getPendidikan(), $this->dbh)."',";
	    $sql .= "'".$this->toolsController->replacecharSave($this->master_pendidikan->getCreated_date(), $this->dbh)."',";
	    $sql .= "'".$this->toolsController->replacecharSave($this->master_pendidikan->getCreated_by(), $this->dbh)."',";
	    $sql .= "'".$this->toolsController->replacecharSave($this->master_pendidikan->getUpdated_date(), $this->dbh)."',";
	    $sql .= "'".$this->toolsController->replacecharSave($this->master_pendidikan->getUpdated_by(), $this->dbh)."' ";
        ...
        function updateData(){
            $datetime = date("Y-m-d H:i:s");
            $sql = "UPDATE master_pendidikan SET ";
	    $sql .= "`id` = '".$this->toolsController->replacecharSave($this->master_pendidikan->getId(),$this->dbh)."',";
	    $sql .= "`pendidikan` = '".$this->toolsController->replacecharSave($this->master_pendidikan->getPendidikan(),$this->dbh)."',";
	    $sql .= "`created_date` = '".$this->toolsController->replacecharSave($this->master_pendidikan->getCreated_date(),$this->dbh)."',";
	    $sql .= "`created_by` = '".$this->toolsController->replacecharSave($this->master_pendidikan->getCreated_by(),$this->dbh)."',";
	    $sql .= "`updated_date` = '".$this->toolsController->replacecharSave($this->master_pendidikan->getUpdated_date(),$this->dbh)."',";
	    $sql .= "`updated_by` = '".$this->toolsController->replacecharSave($this->master_pendidikan->getUpdated_by(),$this->dbh)."' ";
            $sql .= "WHERE id = '".$this->master_pendidikan->getId()."'";                
            $execute = $this->dbh->query($sql);
        }
        
        function deleteData($id){
            $sql = "DELETE FROM master_pendidikan WHERE id = '".$id."'";
            $execute = $this->dbh->query($sql);
        }
        
        function showData($id){
            $sql = "SELECT * FROM master_pendidikan WHERE id = '".$this->toolsController->replacecharFind($id,$this->dbh)."'";

            $row = $this->dbh->query($sql)->fetch();
            $this->loadData($this->master_pendidikan, $row);
            
            return $this->master_pendidikan;
        }
        
        function checkData($id){
            $sql = "SELECT count(*) FROM master_pendidikan where id = '".$id."'";
            $row = $this->dbh->query($sql)->fetch();
            return $row[0];
        }
        ...
        function showDataWhereQuery(){
            ...
            if ($bsearch) {
               ...
               $where .= "       or  pendidikan like '%".$search."%'";
        ...
        function findDataWhere($where){
            $sql = "SELECT * FROM master_pendidikan  ".$where;
            $sql .= " ORDER BY id";
            return $sql;
        }
        function findCountDataWhere($where){
            $sql = "SELECT count(id)  FROM master_pendidikan  ".$where;
            $sql .= " ORDER BY id";
            return $sql;
        }
        ...
        function createList($sql){
            $master_pendidikan_List = array();
            foreach ($this->dbh->query($sql) as $row) {
                    $master_pendidikan_ = new master_pendidikan();
                    $this->loadData($master_pendidikan_, $row);
                    $master_pendidikan_List[] = $master_pendidikan_;
            }
            return $master_pendidikan_List;            
        }

                
        function loadData($master_pendidikan,$row){
	    $master_pendidikan->setId($row['id']);
	    $master_pendidikan->setPendidikan($row['pendidikan']);
	    $master_pendidikan->setCreated_date($row['created_date']);
	    $master_pendidikan->setCreated_by($row['created_by']);
	    $master_pendidikan->setUpdated_date($row['updated_date']);
	    $master_pendidikan->setUpdated_by($row['updated_by']);
        ...
        function showAll(){
            if ($this->ispublic || $this->isadmin || $this->isread ){
                ...
                $master_pendidikan_list = $this->showDataAllLimit();
                ...
                require_once './views/master_pendidikan/master_pendidikan_list.php';
            }else{
        ...
        function showAllJQuery(){
            if ($this->ispublic || $this->isadmin || $this->isread ){
                ...
                $isexport = $this->isexport ;
                $isimport = $this->isimport;
                require_once './views/master_pendidikan/master_pendidikan_jquery_list.php';
            }else{
                echo "You cannot access this module";
            }
        }
        ...
        function showDetail(){
            if ($this->ispublic || $this->isadmin || $this->isread ){
                $id = $_GET['id'];
                $master_pendidikan_ = $this->showData($id);
                require_once './views/master_pendidikan/master_pendidikan_detail.php';
            }else{
                echo "You cannot access this module";
            }
        }
        function showDetailJQuery(){
            if ($this->ispublic || $this->isadmin || $this->isread ){
                $id = $_GET['id'];
                $master_pendidikan_ = $this->showData($id);
                require_once './views/master_pendidikan/master_pendidikan_jquery_detail.php';
            }else{
                echo  "You cannot access this module";
            }
        }
        ...
        function showForm(){
            if ($this->ispublic || $this->isadmin || ($this->isread && $this->isupdate)){
                ...
                $master_pendidikan_ = $this->showData($id);
                require_once './views/master_pendidikan/master_pendidikan_form.php';
            }else{
                echo "You cannot access this module";
            }
        }
        ...
        function showFormJQuery(){
            if ($this->ispublic || $this->isadmin || ($this->isread && $this->isupdate)){
                ...
                $search = isset($_REQUEST["search"]) ? $_REQUEST["search"] : "";
                $master_pendidikan_ = $this->showData($id);
                require_once './views/master_pendidikan/master_pendidikan_jquery_form.php';
            }else{
                echo "You cannot access this module";
            }
        }        
	    ...
	    $this->master_pendidikan->setId($id);
	    $this->master_pendidikan->setPendidikan($pendidikan);
	    $this->master_pendidikan->setCreated_date($created_date);
	    $this->master_pendidikan->setCreated_by($created_by);
	    $this->master_pendidikan->setUpdated_date($updated_date);
	    $this->master_pendidikan->setUpdated_by($updated_by);            
            $this->saveData();
        }
        public function saveData(){
            $check = $this->checkData($this->master_pendidikan->getId());
            if($check == 0){
        ...
        public function getMaster_pendidikan() {
            return $this->master_pendidikan;
        }
        public function setMaster_pendidikan($master_pendidikan) {
            $this->master_pendidikan = $master_pendidikan;
        }
