<?php
    ...
    class master_userControllerGenerate
    {
	    ...
	    $sql .= "'".$this->toolsController->replacecharSave($this->master_user->getShaffid(), $this->dbh)."',";
	    $sql .= "'".$this->toolsController->replacecharSave($this->master_user->getDefaultpassword(), $this->dbh)."',";
	    $sql .= "'".$this->toolsController->replacecharSave($this->master_user->getIdanggota(), $this->dbh)."',";
	    $sql .= "'".$datetime."',";
	    $sql .= "'".$this->user."',";
	    $sql .= "'".$this->ip."',";
	    $sql .= "'".$datetime."',";
	    ...
	    $sql .= "`shaffid` = '".$this->toolsController->replacecharSave($this->master_user->getShaffid(),$this->dbh)."',";
	    $sql .= "`defaultpassword` = '".$this->toolsController->replacecharSave($this->master_user->getDefaultpassword(),$this->dbh)."',";
	    $sql .= "`idanggota` = '".$this->toolsController->replacecharSave($this->master_user->getIdanggota(),$this->dbh)."',";
	    ...
	    $master_user->setShaffid($row['shaffid']);
	    $master_user->setDefaultpassword($row['defaultpassword']);
	    $master_user->setIdanggota($row['idanggota']);
	    ...
	    $shaffid = isset($_POST['shaffid'])?$_POST['shaffid'] : "";
        ...
        public function saveData(){
            $check = $this->checkData($this->toolsController->replacecharSave($this->master_user->getUser(), $this->dbh));
            if($check == 0){
