...
<form name="frmmaster_user" id="frmmaster_user" method="post" action="index.php?model=master_user&action=saveFormJQuery" >
    ...
    <table >        
        ...
        <tr> 
            <td class="textBold">Id Anggota</td> 
            <td><input type="text"  name="idanggota" id="idanggota" value="<?php echo $master_user_->getIdanggota();?>" size="10"></td>
        </tr>
        <tr> 
        ...
        <tr> 
            ...
            <td><input type="text"  name="password" id="password" value="<?php echo ($master_user_->getDefaultpassword());?>" size="40"   ></td>
            <input type="hidden" name="defaultpassword" id="defaultpassword" value="<?php echo ($master_user_->getDefaultpassword());?>">
        </tr>
        <tr> 
            <td class="textBold">Gambar Profil</td> 
            <td>
        ...
        <tr>
            ...
            <td>
                <select name='shaffid' id='shaffid'>
                    <option value="0">
                        Pilih Kelompok
                    </option>
                    <?php
                        foreach ($master_shaff_list as $master_shaff){
                            $selected =($master_user_->getShaffid()==$master_shaff->getId())? "selected":"";
                    ?>
